  ...
  return (
    <>
      <div className="flex flex-col mt-1 p-6">
        ...
        <h1 className="text-3xl font-bold text-[#563A9C] mb-2">Contact Us</h1>
        <p className="text-gray-600 mb-8">
          Plan your monthly, weekly, and daily goals to stay consistent and
          organized.
        </p>
      </div>
      <div className="bg-gray-100 flex flex-col md:flex-row justify-center items-center px-6 gap-10">
        <div className="bg-white shadow-lg rounded-2xl p-8 max-w-2xl w-full">
          <h1 className="text-3xl font-bold text-[#563A9C] mb-4 text-center">
            Get in Touch
          </h1>
          <p className="text-gray-600 text-center mb-8">
            Have questions or feedback ? Fill out the form below — we’d love to
            hear from you!
          </p>
